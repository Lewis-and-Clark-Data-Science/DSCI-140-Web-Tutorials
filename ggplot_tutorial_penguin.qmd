...
#OR you could use the pipe to start with penguin_clean and then create your plot: penguin_clean |> ggplot(aes(x=flipper_length, y=body_mass))+ geom_point()
```
:::
...
summary_data #If your code is successful, this will print the mean flipper length for each island. 
```
